<?php class wpett_TwitterTweets extends WP_Widget{
...
//'/[#]+([A-Za-z0-9-_äÄöÖåÅ]+)/'
	...
	function __construct()  {
		...
		$widget_data = array('classname' => 'wpett_TwitterTweets', 'description' => 'A easy widget which lets you add your latest tweets in just a few clicks on your website.' );
		parent::__construct('wpett_TwitterTweets', 'WP Easy Twitter Feeds', $widget_data);
	}
